...
import su.whs.widgets.AppListFragment;
import su.whs.widgets.AppListFragment.OnSelectionChangedListener;
import su.whs.R;
...
public class InstalledApplicationAdapter extends
	...
	private OnSelectionChangedListener mOnChecked;
	
	
		
	public InstalledApplicationAdapter(Context ctx, List<InstalledApplicationModel> entries, int tvri) {
		super(ctx,tvri);
		mOnChecked = (AppListFragment.OnSelectionChangedListener) context;		
		context = ctx;
		items = entries;
	}
